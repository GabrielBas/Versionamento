...
public class PlayerStatController : MonoBehaviour
{
    ...
    public void PurchaseMoveSpeed()
    {
        ...
        Player.instance.speed = moveSpeed[moveSpeedLevel].value;
    }
    ...
    public void PurchasePickupRange()
    {
        ...
        Player.instance.pickupRange = pickupRange[pickupRangeLevel].value;
    }
    ...
    public void PurchaseMaxWeapons()
    {
        ...
        Player.instance.maxWeapons = Mathf.RoundToInt(maxWeapons[maxWeaponsLevel].value);
    }
